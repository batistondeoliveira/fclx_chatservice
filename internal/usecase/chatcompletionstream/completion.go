...
import (
	...
	"github.com/batistondeoliveira/fclx/chatservice/internal/domain/entity"
	"github.com/batistondeoliveira/fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	assistant, err := entity.NewMessage("assist", fullResponse.String(), chat.Config.Model)
	if err != nil {
