...
import (
	...
	"github.com/batistondeoliveira/fclx/chatservice/configs"
	"github.com/batistondeoliveira/fclx/chatservice/internal/infra/grpc/server"
	"github.com/batistondeoliveira/fclx/chatservice/internal/infra/repository"
	"github.com/batistondeoliveira/fclx/chatservice/internal/infra/web"
	"github.com/batistondeoliveira/fclx/chatservice/internal/infra/web/webserver"
	"github.com/batistondeoliveira/fclx/chatservice/internal/usecase/chatcompletion"
	"github.com/batistondeoliveira/fclx/chatservice/internal/usecase/chatcompletionstream"
...
func main() {
	...
	usecaseStream := chatcompletionstream.NewChatCompletionUseCase(
		repo,
		client,
		streamChannel,
	)
